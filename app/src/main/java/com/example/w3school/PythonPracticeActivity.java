...
public class PythonPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.python_practice);  // Use your XML layout file here
    ...
    private void calculateScore() {
        ...
        if (answer1.equals("def")) score++;
        if (answer2.equals("for loop")) score++;
        if (answer3.equals("Using []")) score++;
        if (answer4.equals("#")) score++;
        if (answer5.equals("Using {}")) score++;
    }
    ...
    private void showResultDialog() {
        ...
        resultMessage.append("1. def\n");
        resultMessage.append("2. for loop\n");
        resultMessage.append("3. Using []\n");
        resultMessage.append("4. #\n");
        resultMessage.append("5. Using {}");

...
public class JsPracticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.js_practice);  // Use your XML layout file here
    ...
    private void calculateScore() {
        ...
        if (answer1.equals("Web Development")) score++;
        if (answer2.equals("function")) score++;
        if (answer3.equals("Using object literals")) score++;
        if (answer4.equals("Dot notation")) score++;
        if (answer5.equals("Using var, let, or const")) score++;
    }
    ...
    private void showResultDialog() {
        ...
        resultMessage.append("1. Web Development\n");
        resultMessage.append("2. function\n");
        resultMessage.append("3. Using object literals\n");
        resultMessage.append("4. Dot notation\n");
        resultMessage.append("5. Using var, let, or const");
